...
public class EditHostGUI implements InventoryProvider {
    ...
    public void init(Player player, InventoryContents contents) {
        ...
        if(configType.type == ConfigHostGUI.ValueType.BOOLEAN){
            ...
            ItemStack builder1 = new ItemBuilder(Material.BANNER).setName("§c-3").setBanner(DyeColor.RED, new Pattern(DyeColor.WHITE, PatternType.HALF_HORIZONTAL), new Pattern(DyeColor.RED, PatternType.BORDER)).toItemStack();
            ...
            ItemStack builder2 = new ItemBuilder(Material.BANNER).setName("§c-2").setBanner(DyeColor.ORANGE, new Pattern(DyeColor.WHITE, PatternType.HALF_HORIZONTAL), new Pattern(DyeColor.ORANGE, PatternType.BORDER)).toItemStack();
            ...
            ItemStack builder3 = new ItemBuilder(Material.BANNER).setName("§c-1").setBanner(DyeColor.YELLOW, new Pattern(DyeColor.WHITE, PatternType.HALF_HORIZONTAL), new Pattern(DyeColor.YELLOW, PatternType.BORDER)).toItemStack();
